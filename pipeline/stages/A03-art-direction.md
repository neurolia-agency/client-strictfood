...
| Nature | Creatif |
| Raison | Decisions visuelles fondatrices (moodboard, vocabulaire visuel, emotion map, dials) |
...
**Note** : Les choix colors.md et typography.md (A02) peuvent avoir ete informes par `ui-ux-pro-max` (donnees CSV palettes/typo). Les outputs A02 restent la source de verite pour A03.
