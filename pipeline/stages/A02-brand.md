...
| Nature | Creatif (orchestrateur) |
| Raison | Travail de brand le plus critique — plateforme, archetypes, tone, copywriting |
...
| **3b. Identité visuelle & Personas** | [03-production-visual.md](A02-brand/03-production-visual.md) | 3 fichiers : personas, colors, typography | `ui-ux-pro-max` |
...
**Skill requis** : `/brand-expression` (Phase 3a — expression verbale), `ui-ux-pro-max` (Phase 3b — donnees palettes/typo, systematique)
