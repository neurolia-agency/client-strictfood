...
| Cle | Valeur |
|-----|--------|
| Modele | `opus-4.6` (medium effort) |
| Nature | Creatif |
| Raison | Decisions creatives visuelles — palette couleurs, typographie, personas narratifs |
...
## Point de depart ui-ux-pro-max (couleurs)

> **Systematique** : consulter `.claude/skills/ui-ux-pro-max/data/colors.csv` pour selectionner 2-3 palettes candidates par type de produit, puis personnaliser selon l'archetype. Si palette deja definie, le lookup sert a valider ou explorer des alternatives.

## Contraintes Qualite (couleurs)
- [ ] Max 1 couleur d'accent
- [ ] Saturation accent < 80%
- [ ] Pas de purple/blue "AI aesthetic"
- [ ] Pas de neon/outer glows prevus
- [ ] Pas de pure black #000000 — utiliser off-black/zinc-950
- [ ] Bases neutres : Zinc ou Slate (pas de gris chaud/froid mixe)
```
...
### Point de depart ui-ux-pro-max (typographie)

> **Systematique** : consulter `.claude/skills/ui-ux-pro-max/data/typography.csv` pour selectionner 2-3 pairings candidats par mood/industrie, puis evaluer contre l'archetype. Si pairing deja defini, le lookup sert a valider ou explorer des alternatives.
...
- [ ] Police heading ≠ Inter (anti-generique)
- [ ] Police heading ≠ police par defaut systeme
- [ ] Si Dashboard/Software UI : Serif BANNI pour heading
- [ ] Polices recommandees : Geist, Outfit, Cabinet Grotesk, Satoshi
- [ ] Si choix different des recommandations : justifier pourquoi cette police incarne mieux l'archetype
```
