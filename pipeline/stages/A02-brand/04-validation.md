...
| Cle | Valeur |
|-----|--------|
| Modele | `sonnet-4.6` (medium effort) |
| Nature | Validation |
| Raison | Verification mecanique (checklist 44 items) — pas de creation |
...
### Qualite visuelle
- [ ] **colors.md** : Max 1 accent, saturation < 80%, pas de purple/blue AI aesthetic, pas de #000
- [ ] **colors.md** : Noms de couleurs evocateurs et coherents avec l'univers de marque
- [ ] **typography.md** : Pas d'Inter heading, serif contraint si Dashboard, choix justifie par archetype
- [ ] **00-platform.md** : Section "Calibrage Frontend" remplie (layout, mouvement, densite, registre visuel, techniques)
- [ ] **Carte de Derivation** : Inclut les lignes visuelles/frontend (Archetype → project-dials, constraints, visual-vocabulary)
