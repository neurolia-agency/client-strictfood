...
| **A02** | `A02-brand/` | `00-brief.md`, `pipeline/input/forms/*` (si référencé dans Sources Externes), `.claude/skills/ui-ux-pro-max/data/` | `pipeline/output/01-brand/` (8 fichiers) | A01 |
