# Recette — STRICT MAX Poulet

## Identité

| Champ | Valeur |
|-------|--------|
| Nom | STRICT MAX Poulet |
| Catégorie | Burgers |
| Prix | 15,99 € |
| Kcal | 946 |
| Protéines | 112 g |
...
- Version MAX = double filet de poulet — le burger est nettement plus haut et imposant
- Cuisson à chaleur pulsée (pas de grill marks traditionnels — la croûte est uniforme, type Maillard four)
- Zéro huile de cuisson
- 112g de protéines — le plus protéiné de toute la carte
